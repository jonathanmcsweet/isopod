...
if command -v shellcheck >/dev/null 2>&1; then
  shellcheck -S warning isopod lib/isopod.d/*.sh share/isopod-entrypoint lib/find_box_repo.sh lib/guest_egress_allow.sh install.sh test/run.sh test/packaging.sh test/egress-render.sh test/brew-formula.sh test/distro-install.sh test/host-verify.sh verify-host-isolation.sh
...
SHFMT_FILES="isopod lib/isopod.d/*.sh share/isopod-entrypoint lib/find_box_repo.sh lib/guest_egress_allow.sh install.sh verify-host-isolation.sh test/run.sh test/packaging.sh test/egress-render.sh test/brew-formula.sh test/distro-install.sh test/host-verify.sh test/helper.bash completions/isopod.bash"
